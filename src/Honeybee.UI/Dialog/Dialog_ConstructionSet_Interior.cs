...
{
    public class Dialog_ConstructionSet_Interior : Dialog<InteriorSet>
    {

        private ConstructionSetViewModel_Interior _vm;
        ...
        private GroupBox GenInteriorSetPanel(bool lockedMode)
        {
            ...
            ceiling.Command = vm.RoofIntSet.SelectConstrucitonCommand;
            ...
            intFloor.Command = vm.FloorIntSet.SelectConstrucitonCommand;
            ...
            var apt = new Button();
            apt.Command = vm.ApertureIntSet.SelectConstrucitonCommand;
            ...
            var door = new Button();
            door.Command = vm.DoorIntSet.SelectConstrucitonCommand;
            ...
            doorGlass.Command = vm.DoorIntGlassSet.SelectConstrucitonCommand;
            ...
            var gp = new GroupBox() { Text = "Interior Construction Set" };
            gp.Content = layout;
