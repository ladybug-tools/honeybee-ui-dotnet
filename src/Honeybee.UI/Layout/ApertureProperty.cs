...
namespace Honeybee.UI.View
{
    ...
    public class ApertureProperty : Panel
    {
        ...
        private static Type _HBObjType = typeof(HB.Aperture);
        private static HB.Aperture _dummy = new HB.Aperture("test", new HB.Face3D(new List<List<double>>()), new HB.Outdoors(), new HB.AperturePropertiesAbridged());
        ...
        private DynamicLayout GenGeneralPanel()
        {
            ...
            var isOperableLabel = new Label() { Text = "Is Operable:" };
            isOperableLabel.ToolTip = Utility.NiceDescription(HoneybeeSchema.SummaryAttribute.GetSummary(_HBObjType, nameof(_dummy.IsOperable)));
        ...
        private GroupBox GenRadiancePanel()
        {
            ...
            ModifierBlkLabel.ToolTip = Utility.NiceDescription(HoneybeeSchema.SummaryAttribute.GetSummary(typeof(HB.ApertureRadiancePropertiesAbridged), nameof(_dummy.Properties.Radiance.ModifierBlk)));
            ...
            DynamicGroupIdentifierLabel.ToolTip = Utility.NiceDescription(HoneybeeSchema.SummaryAttribute.GetSummary(typeof(HB.ApertureRadiancePropertiesAbridged), nameof(_dummy.Properties.Radiance.DynamicGroupIdentifier)));
        ...
        private GroupBox GenEnergyPanel()
        {
            ...
            ConstructionLabel.ToolTip = Utility.NiceDescription(HoneybeeSchema.SummaryAttribute.GetSummary(typeof(HB.ApertureEnergyPropertiesAbridged), nameof(_dummy.Properties.Energy.Construction)));
